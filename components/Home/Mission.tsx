                ...
                <ul className="flex flex-col gap-[var(--spacing-09)] sm:gap-[var(--spacing-08)]">
                    <li className="flex flex-col sm:flex-row gap-[var(--spacing-05)] sm:gap-[var(--spacing-08)]">
                        ...
                        <div className="space-y-[var(--spacing-02)] sm:space-y-[var(--spacing-03)]">
                            <h3 className="heading-01 text-[var(--text-primary)]">{t("Building a Safer Future")}</h3>
                    ...
                    <li className="flex flex-col sm:flex-row gap-[var(--spacing-05)] sm:gap-[var(--spacing-08)]">
                        ...
                        <div className="space-y-[var(--spacing-02)] sm:space-y-[var(--spacing-03)]">
                            <h3 className="heading-01 text-[var(--text-primary)]">{t("Advancing Earthquake Resilience")}</h3>
                    ...
                    <li className="flex flex-col sm:flex-row gap-[var(--spacing-05)] sm:gap-[var(--spacing-08)]">
                        ...
                        <div className="space-y-[var(--spacing-02)] sm:space-y-[var(--spacing-03)]">
                            <h3 className="heading-01 text-[var(--text-primary)]">{t("Empowering Communities")}</h3>
