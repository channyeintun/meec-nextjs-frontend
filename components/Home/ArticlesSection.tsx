...
export const ArticlesSection = async () => {
    ...
    return (
        <section role="region" aria-label="Latest articles" className="sm:px-8 grid lg:grid-cols-[160px_1fr] gap-6 sm:gap-[var(--spacing-08)] lg:gap-[var(--spacing-11)] py-[var(--spacing-11)]">
