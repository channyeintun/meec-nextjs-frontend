...
export const PublicationsSection = () => {
    ...
    return (
        <section className="max-w-[1312px] mx-auto px-[var(--spacing-05)] sm:px-[var(--spacing-07)] pt-[var(--spacing-10)] pb-[var(--spacing-12)] sm:pb-[var(--spacing-13)] space-y-[var(--spacing-10)]">
            <div className="grid lg:grid-cols-[290px_1fr] gap-[var(--spacing-07)]">
                <h2 className="heading-01 text-[var(--text-primary)]">Publications</h2>
