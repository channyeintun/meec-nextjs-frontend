...
export const PublicationsSection = () => {
    ...
    return (
        <section className="max-w-[96rem] mx-auto px-[var(--spacing-05)] sm:px-[var(--spacing-07)] pt-[var(--spacing-10)] pb-[var(--spacing-12)] sm:pb-[var(--spacing-13)] space-y-[var(--spacing-10)]">
